...
function animate() {
  ...
  .addLabel('frame2', 'frame1+=3.7')
    .to('#copy2', 1, {y:0, autoAlpha: 1, ease: Power1.easeInOut}, 'frame2')
    .to('#copy2', 0.5, {autoAlpha: 0, ease: Power1.easeInOut}, 'frame2+=3.5')

  .addLabel('frame3', 'frame2+=3.7')
    .to('#copy21', 1, {y:0, autoAlpha: 1, ease: Power1.easeInOut}, 'frame3')
    .to('#copy21', 0.5, {autoAlpha: 0, ease: Power1.easeInOut}, 'frame3+=3.5')

  .addLabel('frame4', 'frame3+=3.7')
    .to('#copy22', 1, {y:0, autoAlpha: 1, ease: Power1.easeInOut}, 'frame4')

  .addLabel('frame5', 'frame+=3.5')
    .to('#lastFrame',0.5,{y: 0, ease: Power1.easeInOut}, 'frame5')
    .to('#shine', 0.5, {backgroundPosition: '265px 0px'}, 'frame5+=1');
}
